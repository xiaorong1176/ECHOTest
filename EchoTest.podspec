#
# Be sure to run `pod lib lint EchoTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'EchoTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of EchoTest.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'EchoTest/Classes/**/*'
  
  # s.resource_bundles = {
  #   'EchoTest' => ['EchoTest/Assets/*.png']
  # }
